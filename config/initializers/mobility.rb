Mobility.configure do
  ...
  plugins do
    ...
    # backend name.
    #
    # FINS uses the Column backend exclusively: translated attributes are
    # plain `name_en` / `name_ms` columns on the model's own table (see
    # dofi-multilingual-strategy.md). No shared polymorphic translations
    # table is used.
    backend :column
