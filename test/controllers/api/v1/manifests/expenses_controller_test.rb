    ...
    module Manifests
      class ExpensesControllerTest < ActionDispatch::IntegrationTest
        setup do
          ...
          permissions = %w[manifest_expenses.view manifest_expenses.create manifest_expenses.update].map do |code|
        ...
        test "create upserts the expense record" do
          ...
          post "/api/v1/manifests/#{@manifest.id}/expense", params: params, headers: @headers, as: :json
        ...
        test "update modifies the existing expense without creating a duplicate" do
          ...
          assert_no_difference("ManifestExpense.count") do
            patch "/api/v1/manifests/#{@manifest.id}/expense",
        ...
        test "show returns not_found when no expense exists yet" do
          get "/api/v1/manifests/#{@manifest.id}/expense", headers: @headers
