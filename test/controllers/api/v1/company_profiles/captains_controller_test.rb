    ...
    module CompanyProfiles
      class CaptainsControllerTest < ActionDispatch::IntegrationTest
        ...
        test "index requires the list/view permission" do
          get "/api/v1/company_profiles/#{@company_profile.id}/captains", headers: @plain_headers

          assert_response :forbidden

          get "/api/v1/company_profiles/#{@company_profile.id}/captains", headers: @admin_headers
        ...
        test "create adds a pending captain under the company" do
          ...
          assert_difference("CompaniesCaptain.count", 1) do
            post "/api/v1/company_profiles/#{@company_profile.id}/captains", params: params,
        ...
        test "destroy soft-deletes the captain" do
          ...
          delete "/api/v1/company_profiles/#{@company_profile.id}/captains/#{captain.id}", headers: @admin_headers
