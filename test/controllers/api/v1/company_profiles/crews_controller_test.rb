    ...
    module CompanyProfiles
      class CrewsControllerTest < ActionDispatch::IntegrationTest
        ...
        test "index requires the list/view permission" do
          get "/api/v1/company_profiles/#{@company_profile.id}/crews", headers: @plain_headers

          assert_response :forbidden

          get "/api/v1/company_profiles/#{@company_profile.id}/crews", headers: @admin_headers
        ...
        test "create adds a pending crew member under the company" do
          ...
          assert_difference("CompaniesCrew.count", 1) do
            post "/api/v1/company_profiles/#{@company_profile.id}/crews", params: params,
        ...
        test "destroy soft-deletes the crew member" do
          ...
          delete "/api/v1/company_profiles/#{@company_profile.id}/crews/#{crew.id}", headers: @admin_headers
