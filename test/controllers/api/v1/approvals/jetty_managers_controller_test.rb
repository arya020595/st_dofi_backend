    ...
    module Approvals
      class JettyManagersControllerTest < ActionDispatch::IntegrationTest
        ...
        test "index requires the list/view permission" do
          get "/api/v1/approvals/jetty_managers", headers: @plain_headers

          assert_response :forbidden

          get "/api/v1/approvals/jetty_managers", headers: @admin_headers
        ...
        test "approve transitions the jetty manager from pending to active" do
          post "/api/v1/approvals/jetty_managers/#{@jetty_manager.id}/approve", headers: @admin_headers
        ...
        test "approve without permission is forbidden" do
          post "/api/v1/approvals/jetty_managers/#{@jetty_manager.id}/approve", headers: @plain_headers
        ...
        test "reject requires an approval_remark_id and persists its name as the rejection reason" do
          ...
          post "/api/v1/approvals/jetty_managers/#{@jetty_manager.id}/reject",
        ...
        test "a fisherman id 404s against the jetty manager approval endpoints" do
          ...
          get "/api/v1/approvals/jetty_managers/#{fisherman.id}", headers: @admin_headers
