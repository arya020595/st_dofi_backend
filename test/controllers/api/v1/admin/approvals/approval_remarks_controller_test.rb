    ...
    module Approvals
      class ApprovalRemarksControllerTest < ActionDispatch::IntegrationTest
        ...
        test "index requires the list/view permission" do
          get "/api/v1/admin/approvals/approval_remarks", headers: @plain_headers

          assert_response :forbidden

          get "/api/v1/admin/approvals/approval_remarks", headers: @admin_headers
        ...
        test "index filters by name via ransack" do
          ...
          get "/api/v1/admin/approvals/approval_remarks", params: { q: { name_cont: "Findable" } },
        ...
        test "create without permission is forbidden" do
          post "/api/v1/admin/approvals/approval_remarks", params: { approval_remark: { name: "Blocked" } },
        ...
        test "create with a duplicate name returns errors" do
          post "/api/v1/admin/approvals/approval_remarks", params: { approval_remark: { name: @target.name } },
                                                           headers: @admin_headers, as: :json
        ...
        test "destroy soft-deletes the target remark" do
          delete "/api/v1/admin/approvals/approval_remarks/#{@target.id}", headers: @admin_headers
