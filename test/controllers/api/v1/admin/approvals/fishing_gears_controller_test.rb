    ...
    module Approvals
      class FishingGearsControllerTest < ActionDispatch::IntegrationTest
        setup do
          ...
          admin_permissions = %w[view list approve request_amendment].map do |action|
        ...
        test "index requires the list/view permission" do
          get "/api/v1/admin/approvals/fishing_gears", headers: @plain_headers

          assert_response :forbidden

          get "/api/v1/admin/approvals/fishing_gears", headers: @admin_headers

          assert_response :ok
        end

        test "approve transitions the company fishing gear from pending to approved" do
          post "/api/v1/admin/approvals/fishing_gears/#{@gear.id}/approve", headers: @admin_headers
        ...
        test "request_amendment records the remarks and moves the gear to amendment_required" do
          post "/api/v1/admin/approvals/fishing_gears/#{@gear.id}/request_amendment",
