      ...
      class PortsControllerTest < ActionDispatch::IntegrationTest
        ...
        test "create persists a port" do
          assert_difference("Port.count", 1) do
            post "/api/v1/admin/master_data/ports", params: { port: { port_name: "New Port" } }, headers: @headers,
                                                   as: :json
          end
        ...
        test "update modifies the port" do
          patch "/api/v1/admin/master_data/ports/#{@port.id}", params: { port: { port_name: "Renamed Port" } },
