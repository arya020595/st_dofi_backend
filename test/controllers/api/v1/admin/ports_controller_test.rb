    ...
    module Admin
      class PortsControllerTest < ActionDispatch::IntegrationTest
        ...
        test "index lists ports" do
          get "/api/v1/admin/ports", headers: @headers
        ...
        test "show returns the port" do
          get "/api/v1/admin/ports/#{@port.id}", headers: @headers
        ...
        test "create persists a port" do
          assert_difference("Port.count", 1) do
            post "/api/v1/admin/ports", params: { port: { port_name: "New Port" } }, headers: @headers, as: :json
          end
        ...
        test "update modifies the port" do
          patch "/api/v1/admin/ports/#{@port.id}", params: { port: { port_name: "Renamed Port" } },
        ...
        test "destroy removes the port" do
          delete "/api/v1/admin/ports/#{@port.id}", headers: @headers
