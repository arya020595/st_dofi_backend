      ...
      class ZonesControllerTest < ActionDispatch::IntegrationTest
        ...
        test "create persists a zone" do
          assert_difference("Zone.count", 1) do
            post "/api/v1/admin/master_data/zones", params: { zone: { name: "New Zone", zone_type: "offshore",
        ...
        test "update modifies the zone" do
          patch "/api/v1/admin/master_data/zones/#{@zone.id}", params: { zone: { name: "Renamed Zone" } },
                                                   headers: @headers, as: :json
