  ...
  module V1
    class UsersControllerRoleRestrictionTest < ActionDispatch::IntegrationTest
      ...
      test "create rejects a Jetty Manager role_id" do
        ...
        post "/api/v1/users", params: { user: { name: "Blocked", role_id: jetty_manager_role.id } },
      ...
      test "create rejects a Fisherman role_id" do
        ...
        post "/api/v1/users", params: { user: { name: "Blocked", role_id: fisherman_role.id } },
                              headers: @admin_headers, as: :json
      ...
      test "create allows a DoFi Officer role_id" do
        ...
        post "/api/v1/users", params: { user: { name: "Allowed Officer", position: "Administrator",
      ...
      test "create allows a nil role_id" do
        post "/api/v1/users", params: { user: { name: "No Role" } },
                              headers: @admin_headers, as: :json
