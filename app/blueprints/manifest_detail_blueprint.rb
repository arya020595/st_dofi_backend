class ManifestDetailBlueprint < Blueprinter::Base
  ...
  fields :manifest_number, :fisherman_category, :manifest_status, :port_out_status, :port_in_status,
         ...
         :zone_area, :zone_name, :longitude, :latitude, :capture_report_skipped, :skip_reason_name,
         :skip_reason_remarks, :has_minor_fishermen, :companies_vessel_id, :captain_crew_id,
         :company_profile_id, :port_out_id,
